...
scripts = [
    ...
    ("./src/actualGeneration.py", 16000, "./data/standard.json", "./data/actual16000.json"),
    ("./src/merchFIAndAssoRules.py", 0.3, 0.8, "./data/actual16000.json", "./data/csv/freq_items16000.csv", "./data/csv/asso_rules16000.csv", "./data/freq_items16000.json"),
    ("./src/recStandard.py", 500, "./data/csv/freq_items16000.csv", "./results/recStandard16000.json"),
    ("./src/actualGeneration.py", 16000, "./results/recStandard16000.json", "./data/newActual16000.json")
