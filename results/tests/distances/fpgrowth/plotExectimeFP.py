...
times100 = parseTime("./results/tests/distances/fpgrowth/exectime100.txt")
times500 = parseTime("./results/tests/distances/fpgrowth/exectime500.txt")
times1000 = parseTime("./results/tests/distances/fpgrowth/exectime1000.txt")
...
plt.title("Execution time according to the number of actual routes (FPgrowth algorithm)")
